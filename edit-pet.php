...
<form action="save-changes.php" method="POST">
	...
	<div>
		...
		<input type="text" name="gender" placeholder="Pet Gender" value="<?php echo $pet->getPetGender();?>" />	
	</div>
	...
	<div>
		...
		<input type="text" name="owner" placeholder="Owner's Name" value="<?php echo $pet->getOwnerName();?>" />	
	</div>

	<div>
		<label>Email Address</label>
		<input type="email" name="email" placeholder="example@gmail.com" value="<?php echo $pet->getEmailAddress();?>" />	
	</div>
